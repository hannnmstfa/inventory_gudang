...
Route::middleware('auth')->group(function () {
    ...
    */
    ...
    Route::middleware('checkRole:superadmin,kepala gudang,admin gudang')->group(function () {
        ...
        Route::get('/api/laporan-stok/satuan', [LaporanStokController::class, 'getSatuan']);
        ...
        Route::get('/api/laporan-barang-masuk/supplier', [LaporanBarangMasukController::class, 'getSupplier']);
        ...
        Route::get('/api/laporan-barang-keluar/customer', [LaporanBarangKeluarController::class, 'getCustomer']);
    ...
    */
    ...
    Route::middleware('checkRole:superadmin,admin gudang')->group(function () {
        ...
        Route::get('/api/barang-masuk/satuan', [BarangMasukController::class, 'getSatuan']);
        ...
        Route::get('/api/barang-keluar/satuan', [BarangKeluarController::class, 'getSatuan']);
